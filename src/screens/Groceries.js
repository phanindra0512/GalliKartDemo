...
function Groceries({ props, navigation }) {
    ...
    const [isTitle, setIsTitle] = useState('Groceries')
    ...
    const borderTheme = () => { borderWidth = 2, backgroundColor = 'green' }
    return (
        <View style={{ flex: 1, }}>
            ...
            <View style={{ flex: 0.22, flexDirection: 'row', marginTop: 10, }}>
                ...
                <TouchableOpacity style={{ flex: 1, }} onPress={() => { setIsValue(1); setIsTitle('Groceries'); setIsAnimating(true); closeIndicator() }}>
                    <View style={{ flex: 1, }}>
                ...
                <TouchableOpacity style={{ flex: 1, }} onPress={() => { setIsValue(0); setIsTitle('Pharmacy'); setIsAnimating(true); closeIndicator() }}>
                    <View style={{ flex: 1, }}>
                        <View style={{ flex: 0.8, alignItems: 'center', justifyContent: 'center', }}>
...

            {
                isAnimating ?
                    (
                        ...
                        >
                            <UIActivityIndicator animating={true} color='#002F72' />
                        </View>
                    ) :
                    (
