...
function CartItems({ navigation }) {
    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#fff' }}>
            ...
            <View style={{ flex: 1, paddingVertical: 7, flexDirection: 'row', }}>
                <View style={{ flex: 2, justifyContent: 'center' }}>
                    <Text style={{ fontSize: 20, fontFamily: 'ProximaNova-Bold', paddingLeft: 10 }}>Sugar</Text>
                </View>
                <View style={{ flex: 1, }}>
                    <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', paddingVertical: 5 }}>
                        <Text style={{ fontFamily: 'ProximaNova-Bold', fontSize: 17 }}>50</Text>
                    </View>
